...
#    def test_invalid_configuration(self):
        ...
        sys.argv.extend(['-f', 'tests/vsg/entity1.vhd'])
        sys.argv.extend(['--junit', 'tests/vsg/config_error.actual.xml'])
        sys.argv.extend(['-p 1'])
...
#    def test_invalid_configuration(self):
        utils.remove_file('tests/vsg/junit/parse_error.actual.xml')
        lStdErr = []
        ...
        sys.argv.extend(['--junit', 'tests/vsg/junit/parse_error.actual.xml'])
        sys.argv.extend(['-p 1'])
...
#    def test_invalid_configuration(self):
        utils.remove_file('tests/vsg/junit/no_error.actual.xml')

        sys.argv = ['vsg']
        sys.argv.extend(['-f', 'tests/vsg/junit/no_error.vhd'])
        sys.argv.extend(['--junit', 'tests/vsg/junit/no_error.actual.xml'])
        sys.argv.extend(['-p 1'])
    ...
    def test_backup_file(self, mock_stdout):
        ...
        if os.path.isfile('tests/vsg/deleteme.vhd'):
            os.remove('tests/vsg/deleteme.vhd')

        if os.path.isfile('tests/vsg/deleteme.vhd.bak'):
            os.remove('tests/vsg/deleteme.vhd.bak')

        shutil.copyfile('tests/vsg/entity1.vhd', 'tests/vsg/deleteme.vhd')

        lExpected = []

        sys.argv = ['vsg']
        sys.argv.extend(['--output_format', 'syntastic'])
        sys.argv.extend(['-f', 'tests/vsg/deleteme.vhd'])
        sys.argv.extend(['--fix'])
        ...
        self.assertTrue(os.path.isfile('tests/vsg/deleteme.vhd.bak'))

        self.assertTrue(filecmp.cmp('tests/vsg/entity1.vhd', 'tests/vsg/deleteme.vhd.bak'))
    ...
    def test_backup_file_without_fix(self, mock_stdout):
        ...
        self.assertFalse(os.path.isfile('tests/vsg/entity1.vhd.bak'))
