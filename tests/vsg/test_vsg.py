...
class testVsg(unittest.TestCase):
    ...
    def test_invalid_configuration(self):
        ...
        lExpected.append('')
        try:
            lActual = subprocess.check_output(['bin/vsg','--configuration','tests/vsg/config_error.json','--output_format','syntastic','-f','tests/vsg/entity1.vhd','--junit','tests/vsg/config_error.actual.xml'])
        except subprocess.CalledProcessError as e:
            lActual = str(e.output.decode('utf-8')).split('\n')
            iExitStatus = e.returncode
