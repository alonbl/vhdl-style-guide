...
class test_component_rule(unittest.TestCase):
    ...
    def test_rule_020_with_separate_generic(self):
        oRule = component.rule_020()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, "component")
        self.assertEqual(oRule.identifier, "020")
    ...
    def test_fix_rule_020_with_separate_generic(self):
        oRule = component.rule_020()
        ...
        lExpected = []
        lExpected.append("")
        utils.read_file(os.path.join(sTestDir, "rule_020_test_input.fixed_separate_generic.vhd"), lExpected)
